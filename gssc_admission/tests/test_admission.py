    ...
    def test_case_1_admissions(self):
        ...
        vals = {
            ...
            'application_number': self.env.ref(
                'gssc_admission.seq_op_admission').id,
            'birth_date': '2002-12-20',
            'course_id': self.env.ref('gssc_core.op_course_5').id,
            'batch_id': self.env.ref('gssc_core.op_batch_4').id,
            'phone': 32234234,
            'mobile': 93432,
            ...
            'register_id': self.env.ref(
                'gssc_admission.op_admission_register_3').id,
            'image': False
        }
        ...
        vals_2 = {
            ...
            'register_id': self.env.ref(
                'gssc_admission.op_admission_register_3').id,
            'student_id': self.env.ref('gssc_core.op_student_18').id,
            'fees_term_id': 2,
            'fees': 1000,
        }
