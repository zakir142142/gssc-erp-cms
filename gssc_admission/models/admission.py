...
class OpAdmission(models.Model):
    ...
    def open_student(self):
        form_view = self.env.ref('gssc_core.view_op_student_form')
        tree_view = self.env.ref('gssc_core.view_op_student_tree')
        value = {
    ...
    def get_import_templates(self):
        return [{
            ...
            'template': '/gssc_admission/static/xls/op_admission.xls'
        }]
