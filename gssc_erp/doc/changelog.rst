...
- Added new backend theme for gssc. `Enterprise`
...
`8.0.0`
-------
- gssc Now compatible with Odoo v8.
- Added demo portal
...
- Added Annoucement Bar on the top to keep users updated with latest news about gssc
- minor bug fixes
