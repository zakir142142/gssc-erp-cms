...

{
    ...
    'qweb': [
        ...
        'static/src/xml/dashboard_ext_gssc.xml'
    ],
    'js': [],
    'images': [
        'static/description/gssc_core_banner.jpg',
    ],
    'installable': True,
    'auto_install': False,
    'application': True,
    'post_init_hook': '_gssc_post_init',
    'assets': {
        'website.assets_frontend': [
            '/gssc_core/static/src/scss/main.scss',
        ],
        'web.assets_backend': [
            '/gssc_core/static/src/scss/style.scss',
            '/gssc_core/static/src/js/g2_review.js',
            '/gssc_core/static/src/xml/review.xml',
            '/gssc_core/static/src/xml/web_client.xml',
        ],
    },
}
