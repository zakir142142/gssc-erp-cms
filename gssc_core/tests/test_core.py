...
class TestCore(TestCoreCommon):
    ...
    def test_case_3_faculty(self):
        ...
        new_faculty = self.op_faculty.create({
            'partner_id': self.env.ref('gssc_core.op_res_partner_30').id,
    ...
    def test_case_5_res_company(self):
        ...
        record = self.env.ref('gssc_core.op_faculty_1'),
    ...
    def test_case_6_student(self):
        ...
        vals = {
            ...
            'gender': 'm',
            'partner_id': self.env.ref('gssc_core.op_res_partner_14').id
    ...
    def test_case_9_faculty_user_wizard(self):
        ...
        faculty_id = self.env.ref('gssc_core.op_faculty_1')
    ...
    def test_case_10_studnet_wizard(self):
        student_id = self.env.ref('gssc_core.op_student_1')
